                                   ...
                                   children: [
                                     Container(
                                       ...
                                       child: Align(alignment: Alignment.bottomCenter, child: Padding(
                                         ...
                                         child: Text("M",style: TextStyle(backgroundColor: Color(0xffFFFFFF)),),
                                       )),
                                     ),
                                     Container(
                                       height: 180,
                                       ...
                                       child: Align(alignment: Alignment.bottomCenter, child: Padding(
                                         padding: const EdgeInsets.only(top: 30),
                                         child: Text("T",style: TextStyle(backgroundColor: Color(0xffFFFFFF)),),
                                       )),
                                     ),
                                     Container(
                                       height: 142,
                                       ...
                                       child: Align(alignment: Alignment.bottomCenter, child: Padding(
                                         padding: const EdgeInsets.only(top: 30),
                                         child: Text("W",style: TextStyle(backgroundColor: Color(0xffFFFFFF)),),
                                       )),
                                     ),
                                     Container(
                                       height: 230,
                                     ...
                                     Container(
                                       ...
                                       child: Align(alignment: Alignment.bottomCenter, child: Padding(
                                         padding: const EdgeInsets.only(top: 30),
                                         child: Text("F",style: TextStyle(backgroundColor: Color(0xffFFFFFF)),),
                                       )),
                                     ),
                                   ],
                                  ),
